...
1. 배성호, 김명선, 정우혁, 우지환. (2024). 팜유 가격 예측을 위한 딥러닝 기반 단기 시계열 예측 모델링. *경영정보학연구*, 26(2), 45-57.

3. 문혜정, 조남욱. (2024). 머신러닝 기반 한국 임야 공매의 낙찰가격 예측. *JCCT*, 2024-1-19.

4. 김경환, 조승민, 송경빈. (2024). LSTM-XGBoost 앙상블 모형을 이용한 월별 전력판매량 예측 알고리즘.

5. 양현성, 박준, 소원호, 심춘보. (2024). 앙상블 조합 방법에 따른 주가 예측 성능 비교.

6. 한진우. (2023). 공공기관 건물 전기 에너지 소비량 예측 기법. 숭실대학교 정보과학대학원 석사학위논문.

7. 김대호. (2024). ARIMAX를 이용한 하루 전 도매 전력시장 가격 예측법. 고려대학교 대학원 전기전자공학과 석사학위논문.

8. 이수민, 정현우. (2024). SVG 기반 시계열 모델을 활용한 전력시장 가격 예측. *전력시스템학회논문지*, 28(1), 23-34.

9. 박지훈, 김나래. (2024). Random Forest를 이용한 단기 전력가격 예측 연구. *한국전력공학회지*, 73(3), 112-120.
